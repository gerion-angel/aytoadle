...
function parsearActividad(data) {
    ...
    try {
        if (device.platform == 'android' || device.platform == 'Android' || device.platform == 'iOS') { //plugin share
            acumulador += "<p><a onclick='muestraPopShare();navigator.share(\"http://193.242.188.196:8080/aytoArroyoEncomienda/index.html?actividad=" + idAct + "\",\"Kurbana\",\"plain/text\");ga(\"send\", \"event\", \"button\", \"click\", \"Facebook\", 1);'>Compartir</a></p>";

        } else { //sin plugin share
            acumulador += "<p><a onclick='muestraPopShare();window.open(\"https://www.facebook.com/sharer/sharer.php?u=http://193.242.188.196:8080/aytoArroyoEncomienda/index.html?actividad=" + idAct + "\",\"_system\");ga(\"send\", \"event\", \"button\", \"click\", \"Facebook\", 1);'>Facebook </a></p>";
            acumulador += "<p><a onclick='muestraPopShare();window.open(\"https://twitter.com/share?url=http://193.242.188.196:8080/aytoArroyoEncomienda/index.html?actividad=" + idAct + "\",\"_system\");ga(\"send\", \"event\", \"button\", \"click\", \"Facebook\", 1);' > Twitter </a></p>";
